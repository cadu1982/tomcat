...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'SP_INCLUI_RECEBE_ADDA114_RR2')
BEGIN
	EXEC ('CREATE PROCEDURE dbo.SP_INCLUI_RECEBE_ADDA114_RR2 AS BEGIN RETURN END')
END
GO

ALTER PROCEDURE dbo.SP_INCLUI_RECEBE_ADDA114_RR2
(
	...
	*/
	...
	INSERT INTO RECEBE_ADDA114_RR2(
		NUMIDENTCDDA, NUMREFALTCADTIT, NUMIDENTCBAIXAOPERAC, NUMREFBAIXAOPERAC, 
		NUMSEQBAIXAOPERAC, NUMCTRLDDA, TIPOBAIXATIT, ISPBIFSACADA,
		--04/11/2021 - RFAQUINI - INCLUSÃO E TRATAMENTO DO CAMPO NOME_PORTADOR
		CODIFSACADA, TIPOPESPORTADOR, CNPJ_CPF_PORTADOR, NOME_PORTADOR, 
		--26/05/2022 - RFAQUINI - INCLUSÃO E TRATAMENTO DO CAMPO DATAHORARECBTTITULO (CATÁLOGO 5.04)
		DATAHORARECBTTITULO, DATAHORABAIXAOPERAC, DATABAIXAOPERAC, VLRBAIXAOPERAC, 
		NUMCODBARRASBAIXAOPE, CANALPAGTO, MEIOPAGTO, DATAHORASITUACAOBAIXAOPERAC, 
		INDCONTINGENCIA, QTDPAGTOREGTD, VLRSALDOATUAL, CODSITUACAOTIT, 
		DATAHORADDA, DATAMOVTO, CODPROCESSA, DATAMANUTENCAO, 
		TIPORETORNO, NOMEARQRET, INDIMPORTACAOVALIDA
	)
	VALUES (
		@NUMIDENTCDDA, @NUMREFALTCADTIT, @NUMIDENTCBAIXAOPERAC, @NUMREFBAIXAOPERAC, 
		@NUMSEQBAIXAOPERAC, @NUMCTRLDDA, @TIPOBAIXATIT, @ISPBIFSACADA, 
		...
		--26/05/2022 - RFAQUINI - INCLUSÃO E TRATAMENTO DO CAMPO DATAHORARECBTTITULO (CATÁLOGO 5.04)
		@DATAHORARECBTTITULO, @DATAHORABAIXAOPERAC, @DATABAIXAOPERAC, @VLRBAIXAOPERAC, 
		@NUMCODBARRASBAIXAOPE, @CANALPAGTO, @MEIOPAGTO, @DATAHORASITBAIXAOPERAC, 
		@INDCONTINGENCIA, @QTDPAGTOREGTD, @VLRSALDOATUAL, @CODSITUACAOTIT, 
		@DATAHORADDA, @DATAMOVTO, @CODPROCESSA, @DATAMANUTENCAO,
		@TIPORETORNO, @NOMEARQRET, NULL
	)
