 ...
 */  
 ...
 DECLARE @DATALIMPEZA DATETIME, @DATAPROCESSAMENTO DATETIME, @DATAHORA DATETIME, @SQLERRO INTEGER, @INDLIMPEZA CHAR,
		 @QTD_REG_DIARIA_MANUT INT

  SELECT @QTD_REG_DIARIA_MANUT = QTD_REG_DIARIA  
  FROM PARAMETROS_LIMPEZA
  WHERE NOME_PROCESSO = 'SP_LIMPEZA_DIARIA_MANUT'
 ...
 IF @SQLERRO <> 0 GOTO TRATAERRO  
    ...
    SELECT TOP (@QTD_REG_DIARIA_MANUT) CODSISLEGADO, DATALEGADO, DATAPEDIDO, NUMCTRLLEGADO   
 ...
 /*LIMPEZA DE MANUT_EXTRATO_PROCESSAMENTO*/   
    SELECT TOP (@QTD_REG_DIARIA_MANUT) CODSISLEGADO, DATALEGADO, DATAPEDIDO, NUMCTRLLEGADO INTO #TMP_MANUT_EXTRATO_PROCESSAMENTO_SEL   
 ...
 IF @SQLERRO <> 0 GOTO TRATAERRO  
   ...
   /*LIMPEZA DE MANUT_BENEFICIARIO*/   
    SELECT TOP (@QTD_REG_DIARIA_MANUT) DATAPEDIDO,DATALEGADO,NUMCTRLLEGADO,CODSISLEGADO INTO #TMP_MANUT_BENEFICIARIO_SEL   
 ...
 /*LIMPEZA DE MANUT_TITULOS*/   
    SELECT TOP (@QTD_REG_DIARIA_MANUT) CODSISLEGADO, DATALEGADO, DATAPEDIDO, NUMCTRLLEGADO INTO #TMP_MANUT_TITULOS_SEL   
    FROM MANUT_TITULOS   
    WHERE DATAPEDIDO < @DATALIMPEZA  
    ORDER BY DATAPEDIDO  
 SELECT @SQLERRO = @@ERROR     
 ...
 IF @SQLERRO <> 0 GOTO TRATAERRO  
   ...
   SELECT @SQLERRO = @@ERROR     
   IF @SQLERRO <> 0 GOTO TRATAERRO  
   --select * from MANUT_TITULOS_PASS   
 ...
 IF @SQLERRO <> 0 GOTO TRATAERRO  
  ...
  /*LIMPEZA DE MANUT_SACELETRONICO*/   
    SELECT TOP (@QTD_REG_DIARIA_MANUT) CODSISLEGADO, DATALEGADO, DATAPEDIDO, NUMCTRLLEGADO INTO #TMP_MANUT_MANUT_SACELETRONICO_SEL   
