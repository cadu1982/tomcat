...
IF NOT EXISTS(SELECT 1 FROM sysobjects WHERE name = 'SP_LIMPEZA_DIARIA_REC')
BEGIN
...
BEGIN
	...
	/*
		...
		--22/03/2023 - JLSANTOS - INCLUSÃO NA RECEBE_ADDA108_RR2_PASS E TRATAMENTO DOS CAMPOS TIPOPESAGREGADOR, NOMEAGREGADOR, AGENCIARECEBEDORA E CNPJ_CPF_AGREGADOR (CATÁLOGO 5.06)
	...
	*/
	...
	SELECT TOP 100000 SEQ_RECEBE, NUMPEDIDO, DATAMOVTO 
	...
	*/
	...
	SELECT TOP 100000 SEQ_RECEBE, NUMIDENTCDDA, DATAMOVTO
	...
	INSERT INTO RECEBE_ADDA108_RR2_PASS
		(	
			...
			--22/03/2023 - JLSANTOS - INCLUSÃO E TRATAMENTO DOS CAMPOS TIPOPESAGREGADOR, NOMEAGREGADOR, AGENCIARECEBEDORA E CNPJ_CPF_AGREGADOR (CATÁLOGO 5.06)  
